...
public class StaffMenu extends Menu {
    ...
    private void viewExistingOrders(Scanner read) {
        ...
        if (filteredOrders.isEmpty()) {
            System.out.println(ColourManager.erColour() + "\nNo orders found for this date." + ColourManager.reColour());
        } else {
    ...
    private void filterOrdersByCustomerName(Scanner read) {
        ...
        String dateInput = "";
        while (true) {
            System.out.printf(ColourManager.ouColour() + "Enter Date (dd-MM-yyyy): " + ColourManager.reColour());
            System.out.print(ColourManager.inColour());
            dateInput = read.nextLine().trim();
            System.out.print(ColourManager.reColour());

            if (dateInput.isEmpty()) {
                System.out.println(ColourManager.erColour() + "Date cannot be empty. Please try again." + ColourManager.reColour());
                continue;
            }

            if (!dateInput.matches("\\d{2}-\\d{2}-\\d{4}")) {
                System.out.println(ColourManager.erColour() + "Invalid date format. Please use dd-MM-yyyy format." + ColourManager.reColour());
                continue;
            }
            break;
        }
        ...
        String nameKeyword = "";
        while (true) {
            System.out.printf(ColourManager.ouColour() + "Enter Customer Name (or part of name): " + ColourManager.reColour());
            System.out.print(ColourManager.inColour());
            nameKeyword = read.nextLine().trim();
            System.out.print(ColourManager.reColour());

            if (nameKeyword.isEmpty()) {
                System.out.println(ColourManager.erColour() + "Customer name cannot be empty. Please try again." + ColourManager.reColour());
                continue;
            }
            break;
        }
        ...
        System.out.println(ColourManager.ouColour() + "\n============= Orders on " + dateInput + " =============" + ColourManager.reColour());
        System.out.println(ColourManager.ouColour() + "Searching " + nameKeyword + "..." + ColourManager.reColour());
        System.out.println(ColourManager.ouColour() + "================================================" + ColourManager.reColour());
        
        if (filteredOrders.isEmpty()) {
            System.out.println(ColourManager.erColour() + "\nNo orders found matching the criteria." + ColourManager.reColour());
        } else {
            printOrders(filteredOrders);
        }
    }
    ...
    private void findPromoCodes(Scanner read) {
        ...
        System.out.println(ColourManager.ouColour() + "\n============== Find Promo Codes ==============" + ColourManager.reColour());
        System.out.printf(ColourManager.ouColour() + "Enter search keyword (leave empty to view all): " + ColourManager.reColour());
        System.out.print(ColourManager.inColour());
        ...
        if (!found) {
            System.out.println(ColourManager.erColour() + "No promo codes found matching your search." + ColourManager.reColour());
        }
        System.out.println(ColourManager.ouColour() + "==============================================" + ColourManager.reColour());
    }
    ...
    private void viewPermanentPromoCodes() {
        ...
        System.out.println(ColourManager.ouColour() + "\n========= Permanent Promo Codes =========" + ColourManager.reColour());
        
        if (permanentPromos.isEmpty()) {
            System.out.println(ColourManager.erColour() + "No permanent promo codes available." + ColourManager.reColour());
        } else {
