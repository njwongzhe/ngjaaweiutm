...
public class CustomerMenu extends Menu {
    ...
    public void makePayment(Scanner read) {
        ...
        if (!promoCodes.isEmpty()) {
            System.out.printf(ColourManager.ouColour() + "\nDo you want to apply a promo code? (y/n): " + ColourManager.reColour());
            System.out.print(ColourManager.inColour());
            String applyPromo = read.nextLine().trim().toLowerCase();
            System.out.print(ColourManager.reColour());
            
            if (applyPromo.equals("y")) {
                while (true) {
                    System.out.printf(ColourManager.ouColour() + "Enter promo code (or 'cancel' to skip): " + ColourManager.reColour());
                    System.out.print(ColourManager.inColour());
                    String promoCode = read.nextLine().trim().toUpperCase();
                    System.out.print(ColourManager.reColour());
                    ...
                    for (PromoCode promo : promoCodes) {
                        if (promo.getCode().equals(promoCode)) {
                            ...
                            System.out.println(ColourManager.suColour() + "Promo code applied! Discount: " + String.format("%.2f", discountAmount) + " (" + promo.getDiscountPercentage() + "%)" + ColourManager.reColour());
                    ...
                    if (order.getPromoCode() != null) {
                        ...
                        System.out.println(ColourManager.erColour() + "Invalid promo code. Please try again." + ColourManager.reColour());
                    }
                }
            }
        }
