            ...
            try {
                ...
                if (choice == 0) {
                    ...
                    if (!customCategory.isEmpty()) {
                        ...
                        boolean exists = foodCategories.stream().anyMatch(cat -> cat.toLowerCase().equals(customCategory.toLowerCase()));
        ...
        while (true) {
            ...
            try {
                ...
                if (choice == 0) {
                    ...
                    if (!customCategory.isEmpty()) {
                        // Check if already exists (non-case sensitive).
                        boolean exists = drinkCategories.stream().anyMatch(cat -> cat.toLowerCase().equals(customCategory.toLowerCase()));
