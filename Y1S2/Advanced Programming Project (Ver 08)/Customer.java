...
public class Customer {
    ...
    public static Customer readCustomerInfo(Scanner read) {
        ...
        while (true) {
            System.out.println();
            System.out.printf(ColourManager.ouColour() + "Enter Customer Name: " + ColourManager.reColour()); // Output
        ...
        String phone;
        while (true) {
            System.out.printf(ColourManager.ouColour() + "Enter Customer Phone Number: " + ColourManager.reColour()); // Output
            System.out.print(ColourManager.inColour());
