...
public class Staff {
    ...
    private static final int REGISTER_CODE = 8888; // Register Code.
    ...
    public static Staff readRegistrationInfo(Scanner read, ArrayList<Staff> existingStaff) {
        ...
        while (true) {
            ...
            if (exists) {
                System.out.println(ColourManager.erColour() + "\nUsername already exists! Please choose another." + ColourManager.reColour()); // Error
                System.out.printf(ColourManager.ouColour() + "\nTry Again? (y/n): " + ColourManager.reColour()); // Ask Input
                System.out.print(ColourManager.inColour());
