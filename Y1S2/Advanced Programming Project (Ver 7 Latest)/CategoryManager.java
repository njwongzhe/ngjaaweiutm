...
public class CategoryManager {
    ...
    public static boolean addFoodCategory(Scanner read) {
        System.out.printf(ColourManager.ouColour() + "\nEnter New Food Category Name: " + ColourManager.reColour()); // Ask Input
        System.out.print(ColourManager.inColour());
        String newCategory = read.nextLine().trim(); // Input
        System.out.print(ColourManager.reColour());
        
        if (newCategory.isEmpty()) {
            System.out.println(ColourManager.erColour() + "Category name cannot be empty!" + ColourManager.reColour()); // Error
            return false;
        }
        ...
        for (String existing : foodCategories) {
            if (existing.toLowerCase().equals(newCategory.toLowerCase())) {
                System.out.println(ColourManager.erColour() + "Category already exists!\n" + ColourManager.reColour()); // Error
                return false;
            }
        }
    ...
    public static boolean addDrinkCategory(Scanner read) {
        System.out.printf(ColourManager.ouColour() + "\nEnter New Drink Category Name: " + ColourManager.reColour()); // Ask Input
        System.out.print(ColourManager.inColour());
        String newCategory = read.nextLine().trim(); // Input
        System.out.print(ColourManager.reColour());
        ...
        for (String existing : drinkCategories) {
            if (existing.toLowerCase().equals(newCategory.toLowerCase())) {
                System.out.println(ColourManager.erColour() + "Category already exists!" + ColourManager.reColour()); // Error
                return false;
            }
        }
    ...
    public static boolean removeFoodCategory(Scanner read, ArrayList<MenuItem> menuItems) {
        printFoodCategories();
        System.out.printf(ColourManager.ouColour() + "\nEnter Category Number to Remove (0 to Cancel): " + ColourManager.reColour()); // Ask Input
        try {
            System.out.print(ColourManager.inColour());
    ...
    public static void manageCategories(Scanner read) {
        while (true) {
            System.out.println(ColourManager.ouColour() + "\n===== Manage Categories =====" + ColourManager.reColour()); // Output
            System.out.print(ColourManager.opColour());
    ...
    private static void manageFoodCategories(Scanner read) {
        while (true) {
            System.out.println(ColourManager.ouColour() + "\n===== Manage Food Categories =====" + ColourManager.reColour()); // Output
            System.out.print(ColourManager.opColour());
    ...
    private static void manageDrinkCategories(Scanner read) {
        while (true) {
            System.out.println(ColourManager.ouColour() + "\n===== Manage Drink Categories =====" + ColourManager.reColour()); // Output
            System.out.print(ColourManager.opColour());
            System.out.println("0. Back"); // Option
