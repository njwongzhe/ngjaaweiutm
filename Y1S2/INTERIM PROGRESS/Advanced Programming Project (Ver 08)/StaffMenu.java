...
public class StaffMenu extends Menu {
    ...
    public static StaffMenu loginOrSignup(Scanner read) {
        ...
        while (!loggedIn) {
            System.out.println();
            System.out.println(ColourManager.ouColour() + "<Staff>" + ColourManager.reColour());
            ...
            System.out.printf(ColourManager.ouColour() + "Select an Option (0 - 2): " + ColourManager.reColour());
            ...
            switch (input) {
                case "0":
                    System.out.println(ColourManager.suColour() + "Exiting Staff access..." + ColourManager.reColour());
                    return null;
                case "1":
                    System.out.println();
                ...
                case "2":
                    ...
                    break;
                default:
                    System.out.println(ColourManager.erColour() + "Invalid option. Try again." + ColourManager.reColour());
            }
        }
    ...
    private boolean login(Scanner read) {
        ...
        for (Staff s : staff) {
            if (s.getName().equals(name) && s.getPassword().equals(password)) {
                System.out.println(ColourManager.suColour() + "Login successful." + ColourManager.reColour());
                return true;
            }
        }
        System.out.println(ColourManager.erColour() + "Login failed. Invalid credentials." + ColourManager.reColour());
        return false;
    }
    ...
    private void signUp(Scanner read) {
        ...
        if (newStaff != null) {
            ...
            System.out.println(ColourManager.suColour() + "Registration successful. You can now login." + ColourManager.reColour());
        } else {
            System.out.println(ColourManager.erColour() + "Registration failed." + ColourManager.reColour());
        }
    }
    ...
    private void viewExistingOrders(Scanner read) {
        System.out.println(ColourManager.ouColour() + "\n================== View Orders =================" + ColourManager.reColour());
        System.out.printf(ColourManager.ouColour() + "\nEnter Date to View (dd-MM-yyyy): " + ColourManager.reColour());
        System.out.print(ColourManager.inColour());
        ...
        if (!foundOrders) {
            System.out.println(ColourManager.erColour() + "No orders found for this date." + ColourManager.reColour());
        }
    }

    private void placeOrder(Scanner read) {
        System.out.println(ColourManager.ouColour() + "\n============== Place Order ==============" + ColourManager.reColour());
        ...
        do {
            ...
            try {
                ...
                if (choice < 0 || choice > 2) {
                    System.out.println(ColourManager.erColour() + "Only inputs (0 - 2) are accepted. Please try again." + ColourManager.reColour());
                    continue;
                }
            } catch(NumberFormatException e) {
                System.out.println(ColourManager.erColour() + "Invalid input. Please try again." + ColourManager.reColour());
                continue;
            }
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                default:
                    System.out.println(ColourManager.erColour() + "Invalid choice." + ColourManager.reColour());
            }
        } while (choice != 0);
        return true;
    }
