...
public class Drink extends MenuItem {
    ...
    public String toCSVString() {
        return String.format("Drink,%s,%.2f,%s,%s,%s,%d", 
                escapeComma(name),
                price,
                menuItemID,
    ...
    public static Drink readDrinkDetails(Scanner read) {
        ...
        System.out.printf("Enter quantity included: ");
        drink.setQuantity(readValidNumber(read, 0, Integer.MAX_VALUE));
        ...
        System.out.printf("Enter drink description (press Enter for default): ");
