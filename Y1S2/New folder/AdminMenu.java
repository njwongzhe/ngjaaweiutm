...
public class AdminMenu extends Menu{
    ...
    private void managePromoCodes(Scanner read) {
        while (true) {
            ...
            System.out.printf(ColourManager.ouColour() + "Select an Option (0-4): " + ColourManager.reColour());
            System.out.print(ColourManager.inColour());
            ...
            try {
                ...
                System.out.println(ColourManager.erColour() + "Error: " + e.getMessage() + ColourManager.reColour());
            }
        }
    }
    ...
    private void generateSinglePromoCode(Scanner read, boolean isPermanent) {
        try {
            ...
            System.out.printf(ColourManager.ouColour() + "Enter Discount Percentage (1-100): " + ColourManager.reColour());
            System.out.print(ColourManager.inColour());
            double discount = Double.parseDouble(read.nextLine());
            System.out.print(ColourManager.reColour());
            ...
            System.out.println(ColourManager.suColour() + "Promo Code Generated: " + code + " (" + (isPermanent ? "Permanent" : "One-Time Use") + ", " + discount + "% discount)" + ColourManager.reColour());
        } catch (NumberFormatException e) {
            System.out.println(ColourManager.erColour() + "Invalid number format. Please enter a valid percentage." + ColourManager.reColour());
        } catch (IllegalArgumentException e) {
            System.out.println(ColourManager.erColour() + e.getMessage() + ColourManager.reColour());
        }
    }
    ...
    private void generateBatchPromoCodes(Scanner read) {
        try {
            ArrayList<PromoCode> existingPromoCodes = FileManager.loadPromoCodes("promocodes.csv");
            System.out.printf(ColourManager.ouColour() + "Enter Number of Promo Codes to Generate: " + ColourManager.reColour());
            System.out.print(ColourManager.inColour());
            ...
            System.out.println(ColourManager.suColour() + "Generating " + count + " one-time use promo codes with " + discount + "% discount..." + ColourManager.reColour());
            ...
            FileManager.savePromoCodes(promoCodeList, "promocodes.csv");
            System.out.println(ColourManager.suColour() + "Batch generation completed." + ColourManager.reColour());
        } catch (NumberFormatException e) {
            System.out.println(ColourManager.erColour() + "Invalid number format. Please enter valid numbers." + ColourManager.reColour());
        } catch (IllegalArgumentException e) {
            System.out.println(ColourManager.erColour() + e.getMessage() + ColourManager.reColour());
        }
    }
    ...
    private void viewPromoCodes() {
        if (promoCodeList.isEmpty()) {
            System.out.println(ColourManager.erColour() + "No promo codes available." + ColourManager.reColour());
            return;
        }

        System.out.println(ColourManager.ouColour() + "\n============ Existing Promo Codes ============" + ColourManager.reColour());
    ...
    private void deletePromoCode(Scanner read) {
        System.out.printf(ColourManager.ouColour() + "Enter Promo Code to Delete: " + ColourManager.reColour());
        System.out.print(ColourManager.inColour());
        String code = read.nextLine().toUpperCase();
        System.out.print(ColourManager.reColour());
        ...
        if (found) {
            FileManager.savePromoCodes(promoCodeList, "promocodes.csv");
            System.out.println(ColourManager.suColour() + "Promo code deleted successfully." + ColourManager.reColour());
        } else {
            System.out.println(ColourManager.erColour() + "Promo code not found." + ColourManager.reColour());
        }
    }
    ...
    public void printMenuOption() {
        ...
        System.out.println("9. Manage Promo Codes");
        System.out.print(ColourManager.reColour());
    }
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 8:
                        ...
                        System.out.println(ColourManager.ouColour() + "======================================================================" + ColourManager.reColour()); // Output
                        break;
                    case 9:  // New case for promo code management
